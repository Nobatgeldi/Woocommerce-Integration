...
if(isset($_SESSION["user_nicname"]))
{
?>
<!DOCTYPE html>
<html>
    ...
    <div class="sidebar">
        <div class="sidebar-inner">
            ...
            <ul class="sidebar-menu scrollable pos-r">
                <li class="nav-item mT-30 active"><a class="sidebar-link" href="/estore/data_gittigidiyor.php"><span class="icon-holder"><i
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="bgc-white bd bdrs-3 p-20 mB-20"><h4 class="c-grey-900 mB-20">Ürünler</h4>
                                ...
                                <form method="post" action="/panel/scripts/get_product.php">
