...
try {
    ...
    $client = new WC_API_Client( 'https://modaphin.com', 'ck_55037681638e4ef4a09fef8d00396c0e00fac008', 'cs_3ab7e5cdc45e580f910e6c15524d71ce4f80f2f4', $options );
    ...
    print_r( $client->products->get_by_sku( '654613612' ) );
